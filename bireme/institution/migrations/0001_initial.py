...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('prefix', models.CharField(max_length=45, verbose_name='Prefix', choices=[(b'Sr.', 'Sr.'), (b'Sra.', 'Sra.'), (b'Dr.', 'Dr.'), (b'Dra.', 'Dra.'), (b'Lic.', 'Lic.'), (b'Prof.', 'Prof.'), (b'Profa.', 'Profa.')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(default=-1, null=True, verbose_name='Status', choices=[(-1, 'Draft'), (1, 'Published'), (2, 'Refused'), (3, 'Deleted')])),
                ...
                ('cc_code', models.CharField(max_length=55, verbose_name='Center code', blank=True)),
        ...
        migrations.AddField(
            ...
            name='type',
            field=models.ForeignKey(verbose_name='Type', to='institution.Type'),
        ),
        migrations.AddField(
            model_name='institution',
            name='updated_by',
