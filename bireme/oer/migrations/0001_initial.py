    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=115, verbose_name='name')),
                ('coursetype', models.ForeignKey(verbose_name='Learning resource type', to='oer.LearningResourceType')),
            ],
            options={
                'verbose_name': 'Translation',
                'verbose_name_plural': 'Translations',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('learning_resource_type', models.ForeignKey(verbose_name='Learning resource type', blank=True, to='oer.LearningResourceType', null=True)),
