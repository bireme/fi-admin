    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=115, verbose_name='name')),
                ('audience', models.ForeignKey(verbose_name='Audience', to='oer.Audience', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=115, verbose_name='name')),
                ('coursetype', models.ForeignKey(verbose_name='Course type', to='oer.CourseType', on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'Translation',
                'verbose_name_plural': 'Translations',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=115, verbose_name='name')),
                ('difficulty', models.ForeignKey(verbose_name='Difficulty', to='oer.Difficulty', on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'Translation',
                'verbose_name_plural': 'Translations',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=115, verbose_name='name')),
                ('format', models.ForeignKey(verbose_name='Format', to='oer.Format', on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'Translation',
                'verbose_name_plural': 'Translations',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=115, verbose_name='name')),
                ('interatype', models.ForeignKey(verbose_name='Interactivity type', to='oer.InteractivityType', on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'Translation',
                'verbose_name_plural': 'Translations',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'Learning resource types',
            },
        ),
        migrations.CreateModel(
            name='LearningResourceTypeLocal',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=115, verbose_name='name')),
                ('coursetype', models.ForeignKey(verbose_name='Learning resource type', to='oer.LearningResourceType', on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'Translation',
                'verbose_name_plural': 'Translations',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=115, verbose_name='name')),
                ('license', models.ForeignKey(verbose_name='License', to='oer.License', on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'Translation',
                'verbose_name_plural': 'Translations',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CVSP_resource', models.BooleanField(default=False, verbose_name='CVSP resource')),
                ...
                ('cvsp_node', models.CharField(max_length=55, verbose_name='CVSP node', blank=True)),
                ...
                ('created_by', models.ForeignKey(related_name='+', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.PROTECT)),
                ('difficulty', models.ForeignKey(verbose_name='Difficulty', blank=True, to='oer.Difficulty', null=True, on_delete=models.PROTECT)),
                ('format', models.ManyToManyField(to='oer.Format', verbose_name='Format', blank=True)),
                ('interactivity_type', models.ForeignKey(verbose_name='Interactivity type', blank=True, to='oer.InteractivityType', null=True, on_delete=models.PROTECT)),
                ('language', models.ForeignKey(verbose_name='Language', blank=True, to='main.SourceLanguage', null=True, on_delete=models.PROTECT)),
                ('learning_resource_type', models.ForeignKey(verbose_name='Learning resource type', blank=True, to='oer.LearningResourceType', null=True, on_delete=models.PROTECT)),
                ('license', models.ForeignKey(verbose_name='Rights license', blank=True, to='oer.License', null=True, on_delete=models.PROTECT)),
            ],
            options={
                'verbose_name': 'Open Educational Resource',
                'verbose_name_plural': 'Open Educational Resources',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='+', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.PROTECT)),
                ('oer', models.ForeignKey(to='oer.OER', null=True, on_delete=models.PROTECT)),
                ('updated_by', models.ForeignKey(related_name='+', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.PROTECT)),
            ],
            options={
                'verbose_name': 'URL',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_time', models.DateTimeField(auto_now=True, verbose_name='updated', null=True)),
                ('created_by', models.ForeignKey(related_name='+', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.PROTECT)),
                ('oer_referred', models.ForeignKey(related_name='referred', verbose_name='OER related', to='oer.OER', null=True, on_delete=models.PROTECT)),
                ('oer_related', models.ForeignKey(related_name='related', to='oer.OER', null=True, on_delete=models.PROTECT)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('label_active', models.CharField(max_length=155, verbose_name='Active form')),
                ('label_passive', models.CharField(max_length=155, verbose_name='Passive form')),
                ('created_by', models.ForeignKey(related_name='+', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.PROTECT)),
                ('updated_by', models.ForeignKey(related_name='+', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.PROTECT)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label_active', models.CharField(max_length=155, verbose_name='Active form')),
                ('label_passive', models.CharField(max_length=155, verbose_name='Passive form')),
                ('relation_type', models.ForeignKey(verbose_name='Relation type', to='oer.RelationType', on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'Translation',
                'verbose_name_plural': 'Translations',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=115, verbose_name='name')),
                ('tecresourcetype', models.ForeignKey(verbose_name='Technical resource type', to='oer.TecResourceType', on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'Translation',
                'verbose_name_plural': 'Translations',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=115, verbose_name='name')),
                ('oer_type', models.ForeignKey(verbose_name='Type', to='oer.Type', on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'Translation',
                'verbose_name_plural': 'Translations',
        ...
        migrations.AddField(
            ...
            name='relation_type',
            field=models.ForeignKey(to='oer.RelationType', on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='relationship',
            name='updated_by',
        ...
        migrations.AddField(
            model_name='oer',
            name='type',
            field=models.ForeignKey(verbose_name='Type', blank=True, to='oer.Type', null=True, on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='oer',
            name='updated_by',
