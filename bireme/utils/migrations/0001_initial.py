...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'utils_country', (
        ...
        db.send_create_signal(u'utils', ['Country'])

        # Adding model 'CountryLocal'
        db.create_table(u'utils_countrylocal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'utils', ['CountryLocal'])


    def backwards(self, orm):
        # Deleting model 'Country'
        db.delete_table(u'utils_country')

        # Deleting model 'CountryLocal'
        db.delete_table(u'utils_countrylocal')
    ...
    models = {
        ...
        u'utils.countrylocal': {
            'Meta': {'object_name': 'CountryLocal'},
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['utils.Country']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
