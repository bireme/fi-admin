    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue_date', models.DateField(help_text=b'DD/MM/YYYY', verbose_name='Issue date', blank=True)),
                ('publication_date', models.DateField(help_text=b'DD/MM/YYYY', verbose_name='Publication date', blank=True)),
                ('effectiveness_date', models.DateField(help_text=b'DD/MM/YYYY', verbose_name='Effectiveness date', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_time', models.DateTimeField(auto_now=True, verbose_name='updated', null=True)),
                ('act_number', models.CharField(max_length=125, verbose_name='Act number', blank=True)),
                ('act_date', models.CharField(max_length=125, verbose_name='Date', blank=True)),
                ('act_apparatus', models.CharField(max_length=125, verbose_name='Apparatus', blank=True)),
                ('act', models.ForeignKey(verbose_name='Act related', blank=True, to='leisref.Act', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('act_related', models.ForeignKey(to='leisref.Act')),
                ('created_by', models.ForeignKey(related_name='+', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True)),
                ('updated_by', models.ForeignKey(related_name='+', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='act',
            name='scope_region',
            field=models.ForeignKey(verbose_name='Act country/region', blank=True, to='leisref.ActCountryRegion', null=True),
        ),
        migrations.AddField(
            model_name='act',
            name='source_name',
