...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'error_reporting_errorreport', (
            ...
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='error_reporting', to=orm['contenttypes.ContentType'])),
            ('status', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ('code', self.gf('django.db.models.fields.SmallIntegerField')(default=3)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('new_link', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
        ))
        db.send_create_signal(u'error_reporting', ['ErrorReport'])


    def backwards(self, orm):
        # Deleting model 'ErrorReport'
        db.delete_table(u'error_reporting_errorreport')
