...
OWNER_CHOICES = (
    ("BioMed", _("BioMed")),
    ("CAPES-BioMed", _("CAPES-BioMed")),
    ("CAPES-BioOne", _("CAPES-BioOne")),
    ("CAPES-Blackwell", _("CAPES-Blackwell")),
    ("CAPES-BMJ", _("CAPES-BMJ")),
    ("CAPES-Cambridge University Press", _("CAPES-Cambridge University Press")),
    ("CAPES-EBSCO", _("CAPES-EBSCO")),
    ("CAPES-Emerald", _("CAPES-Emerald")),
    ("CAPES-Gale", _("CAPES-Gale")),
    ("CAPES-HW", _("CAPES-HW")),
    ("CAPES-Karger", _("CAPES-Karger")),
    ("CAPES-Mary Ann Liebert", _("CAPES-Mary Ann Liebert")),
    ("CAPES-Nature", _("CAPES-Nature")),
    ("CAPES-Outros editores", _("CAPES-Others editors")),
    ("CAPES-OVID", _("CAPES-OVID")),
    ("CAPES-Oxford University Press", _("CAPES-Oxford University Press")),
    ("CAPES-PePSIC", _("CAPES-PePSIC")),
    ("CAPES-PMC", _("CAPES-PMC")),
    ("CAPES-Sage", _("CAPES-Sage")),
    ("CAPES-SciELO", _("CAPES-SciELO")),
    ("CAPES-SDO", _("CAPES-SDO")),
    ("CAPES-Springer", _("CAPES-Springer")),
    ("CAPES-Thieme", _("CAPES-Thieme")),
    ("CAPES-Wilson", _("CAPES-Wilson")),
    ("CAPES-WS", _("CAPES-WS")),
    ("Editor", _("Editor")),
    ("Elsevier", _("Elsevier")),
    ("PePSIC", _("PePSIC")),
