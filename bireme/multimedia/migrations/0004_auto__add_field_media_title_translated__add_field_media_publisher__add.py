...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Media.title_translated'
        db.add_column(u'multimedia_media', 'title_translated',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=455, blank=True),
                      keep_default=False)

        # Adding field 'Media.publisher'
        db.add_column(u'multimedia_media', 'publisher',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Media.publication_date'
        db.add_column(u'multimedia_media', 'publication_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'MediaCollection.date'
        db.add_column(u'multimedia_mediacollection', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'MediaCollection.city'
        db.add_column(u'multimedia_mediacollection', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'MediaCollection.country'
        db.add_column(u'multimedia_mediacollection', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utils.Country'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Media.title_translated'
        db.delete_column(u'multimedia_media', 'title_translated')

        # Deleting field 'Media.publisher'
        db.delete_column(u'multimedia_media', 'publisher')

        # Deleting field 'Media.publication_date'
        db.delete_column(u'multimedia_media', 'publication_date')

        # Deleting field 'MediaCollection.date'
        db.delete_column(u'multimedia_mediacollection', 'date')

        # Deleting field 'MediaCollection.city'
        db.delete_column(u'multimedia_mediacollection', 'city')

        # Deleting field 'MediaCollection.country'
        db.delete_column(u'multimedia_mediacollection', 'country_id')
    ...
    models = {
        ...
        u'multimedia.mediacollection': {
            ...
            'cooperative_center_code': ('django.db.models.fields.CharField', [], {'max_length': '55', 'blank': 'True'}),
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['utils.Country']", 'null': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'created_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
