...
# Comma-separated origins, including the scheme, for HTTPS deployments.
...
ANNIF_API_URL = os.environ.get("ANNIF_API_URL")
AI_SUGGESTION_MODEL = os.environ.get("AI_SUGGESTION_MODEL")
