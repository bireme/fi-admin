    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=255, verbose_name='name')),
                ('act_city', models.ForeignKey(to='leisref.ActCity', on_delete=models.PROTECT)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=255, verbose_name='name')),
                ('act_state', models.ForeignKey(to='leisref.ActState', on_delete=models.PROTECT)),
            ],
            options={
                'verbose_name': 'Translation',
                'verbose_name_plural': 'Translations',
        ...
        migrations.AlterField(
            model_name='act',
            name='scope_city',
            field=models.ForeignKey(verbose_name='Act scope city', blank=True, to='leisref.ActCity', null=True, on_delete=models.PROTECT),
        ),
        migrations.AlterField(
            model_name='act',
            name='scope_state',
            field=models.ForeignKey(verbose_name='Act scope state', blank=True, to='leisref.ActState', null=True, on_delete=models.PROTECT),
        ),
    ]
