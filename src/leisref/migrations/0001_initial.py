    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=255, verbose_name='name')),
                ('act_region', models.ForeignKey(to='leisref.ActCountryRegion', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=255, verbose_name='name')),
                ('organ_issuer', models.ForeignKey(verbose_name='Organ issuer', to='leisref.ActOrganIssuer', on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'Translation',
                'verbose_name_plural': 'Translations',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('act_referred', models.ForeignKey(related_name='referred', verbose_name='Act related', to='leisref.Act', null=True, on_delete=models.PROTECT)),
                ('act_related', models.ForeignKey(related_name='related', to='leisref.Act', null=True, on_delete=models.PROTECT)),
                ('created_by', models.ForeignKey(related_name='+', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.PROTECT)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=255, verbose_name='name')),
                ('relation_type', models.ForeignKey(verbose_name='Act relation type', to='leisref.ActRelationType', on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'Translation',
                'verbose_name_plural': 'Translations',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=255, verbose_name='name')),
                ('act_scope', models.ForeignKey(to='leisref.ActScope', on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'Translation',
                'verbose_name_plural': 'Translations',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=255, verbose_name='name')),
                ('act_source', models.ForeignKey(to='leisref.ActSource', on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'Translation',
                'verbose_name_plural': 'Translations',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(max_length=10, verbose_name='language', choices=[(b'en', 'English'), (b'pt-br', 'Portuguese'), (b'es', 'Spanish')])),
                ('name', models.CharField(max_length=255, verbose_name='name')),
                ('act_type', models.ForeignKey(verbose_name='Act type', to='leisref.ActType', on_delete=models.CASCADE)),
            ],
            options={
                'verbose_name': 'Translation',
                'verbose_name_plural': 'Translations',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('act', models.ForeignKey(to='leisref.Act', null=True, on_delete=models.PROTECT)),
                ('created_by', models.ForeignKey(related_name='+', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.PROTECT)),
                ('updated_by', models.ForeignKey(related_name='+', blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.PROTECT)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='relation_type',
            field=models.ForeignKey(to='leisref.ActRelationType', on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='actrelationship',
            name='updated_by',
        ...
        migrations.AddField(
            model_name='act',
            name='act_type',
            field=models.ForeignKey(verbose_name='Act type', to='leisref.ActType', on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='act',
            name='created_by',
        ...
        migrations.AddField(
            model_name='act',
            name='language',
            field=models.ForeignKey(verbose_name='Language', blank=True, to='main.SourceLanguage', null=True, on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='act',
            name='organ_issuer',
            field=models.ForeignKey(verbose_name='Organ issuer', blank=True, to='leisref.ActOrganIssuer', null=True, on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='act',
            name='scope',
            field=models.ForeignKey(verbose_name='Act scope', blank=True, to='leisref.ActScope', null=True, on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='act',
            name='scope_region',
            field=models.ForeignKey(verbose_name='Act country/region', to='leisref.ActCountryRegion', on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='act',
            name='source_name',
            field=models.ForeignKey(verbose_name='Source name', blank=True, to='leisref.ActSource', null=True, on_delete=models.PROTECT),
        ),
        migrations.AddField(
            model_name='act',
            name='updated_by',
