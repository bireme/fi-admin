...
mx1660 lis_clean pft=@fixture_descriptors.pft gizmo=gizmo_fixture lw=8000 from=1 count=50 now > descriptors_iso.json

mx lis_clean pft=@fixture_keywords.pft gizmo=gizmo_fixture lw=8000 from=1 count=50 now > keywords_iso.json

mx lis_clean pft=@fixture_resource_thematic.pft gizmo=gizmo_fixture gizmo=g_thematic_area,302 lw=8000 from=1 count=50 now > resource_thematic_iso.json
