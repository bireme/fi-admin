...
# gizmo for thematic area
mx config from=1 count=1 "pft=(if p(v300) then v300^c,'|',f(iocc,1,0) fi/)" now > g_thematic_area.seq
mx seq=g_thematic_area.seq create=g_thematic_area -all now
